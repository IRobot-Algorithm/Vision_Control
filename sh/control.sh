...
$PROJECT_DIR/sh/compare_and_cp.py $PROJECT_DIR/src/skider_sw/config/hardware_settings.yaml $PROJECT_DIR/install/skider_sensor/share/skider_sensor/config/hardware_settings.yaml
